...
device = "cuda:0"
ngpu = 1
checkpoint = f"../model/gan_attack/{args.encryption}/netG_epoch_{args.epoch}.pth"
...
print(ssim_df.shape)
ssim_df.to_csv(
    f"../ssim_value/ssim_gan_attack_{args.encryption}.csv", index=False, header=True
)
